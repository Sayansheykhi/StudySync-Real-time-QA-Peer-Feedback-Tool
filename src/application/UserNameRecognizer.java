 ...
 * @version 2.0 - Modified implementation for modified Finite State Machine by Cristina Hooe  2/5/2025
 */
public class UserNameRecognizer {

	/**
     * Declaration of a string-type variable userNameRecognizerErrorMessage which is the error message text to be output
     */
	public static String userNameRecognizerErrorMessage = "";
	
	/**
	 * Declaration of a string-type variable userNameRecognizerInput which is the user input being processed
	 */
	public static String userNameRecognizerInput = "";
	
	/**
	 * Declaration of an int-type variable userNameRecognizerIndexofError which indicates the index of the error location
	 */
	...
	/**
	 * Declaration of an int-type variable userNameSize which is a counter used to keep track of the total characters input for validation
	 * The userName must have no less than 4 characters in total and no more than 16 characters in total
	 */
	...
	public static String checkForValidUserName(String input) {
		...
		if(input.length() <= 0) {
			...
			return "Error UserName: The UserName is empty\n";
		}
		...
		while (running) {
			...
			case 1: 
				...
				// ., _, - -> State 2
				else if (currentChar == '.' || currentChar == '-' || currentChar == '_') {	// Check for . _ or  -
					nextState = 2;
		...
		userNameRecognizerErrorMessage = "Error UserName: ";
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += "A UserName must have at least 4 characters within A-Z, a-z, or 0-9.\n";
				return userNameRecognizerErrorMessage;
			}
